...
export class DashboardPage {
  ...
  private readonly userUsername: Locator
  ...
  async verifyUserDetails(user: { fullName: string; username: string; email: string }) {
...
// function verifyUserDetails(user: any, arg1: { fullName: any; username: any; email: any; }) {
